    ...
    <footer className="bg-[#f9fafb] text-gray-700 py-12 px-4 sm:px-6 md:px-16">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-sm">
        <div className="space-y-2">
          ...
          <p className="text-gray-500 italic">Nature does not rush, and neither should you.</p>
        </div>
        ...
        <div className="space-y-2 text-right md:text-left">
          <p>Made somewhere between rain and stillness.</p>
          <p className="text-xs text-gray-400">Copyright {currentYear} Sarva Holidays</p>
        </div>
      </div>
    </footer>
  )
